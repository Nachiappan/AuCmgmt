...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.reduction'
        db.add_column('order_order', 'reduction', self.gf('django.db.models.fields.FloatField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.reduction'
        db.delete_column('order_order', 'reduction')
    ...
    models = {
        ...
        'order.itemorder': {
            ...
            'delivery_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 6, 7, 8, 438185)', 'null': 'True', 'blank': 'True'}),
        ...
        'order.order': {
            ...
            'order_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 6, 7, 8, 435705)'}),
            'payment_status': ('django.db.models.fields.CharField', [], {'default': "'D'", 'max_length': '1'}),
        ...
        'order.payment': {
            ...
            'payment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 6, 7, 8, 436836)'}),
