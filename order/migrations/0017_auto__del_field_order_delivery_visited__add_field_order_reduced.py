...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.reduced'
        db.add_column('order_order', 'reduced', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.reduced'
        db.delete_column('order_order', 'reduced')
    ...
    models = {
        ...
        'order.itemorder': {
            ...
            'delivery_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 8, 19, 45, 26, 32780)', 'null': 'True', 'blank': 'True'}),
        ...
        'order.order': {
            ...
            'new_total': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'order_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 8, 19, 45, 26, 30373)'}),
            'paid_amount': ('django.db.models.fields.FloatField', [], {'default': '0', 'blank': 'True'}),
            'payment_status': ('django.db.models.fields.CharField', [], {'default': "'D'", 'max_length': '1'}),
            'reduced': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'order.payment': {
            ...
            'payment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 8, 19, 45, 26, 31580)'}),
