...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'order.itemorder': {
            ...
            'delivery_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 8, 15, 26, 6, 542180)', 'null': 'True', 'blank': 'True'}),
        ...
        'order.order': {
            ...
            'deliver_visited': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'new_total': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'order_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 8, 15, 26, 6, 539363)'}),
        ...
        'order.payment': {
            ...
            'payment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 8, 15, 26, 6, 540738)'}),
