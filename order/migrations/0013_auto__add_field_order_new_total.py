...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.new_total'
        db.add_column('order_order', 'new_total', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.new_total'
        db.delete_column('order_order', 'new_total')
    ...
    models = {
        ...
        'order.itemorder': {
            ...
            'delivery_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 17, 54, 35, 460201)', 'null': 'True', 'blank': 'True'}),
        ...
        'order.order': {
            ...
            'new_total': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'order_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 17, 54, 35, 457542)'}),
        ...
        'order.payment': {
            ...
            'payment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 17, 54, 35, 458863)'}),
