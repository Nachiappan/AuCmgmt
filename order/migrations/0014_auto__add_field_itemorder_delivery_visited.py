...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ItemOrder.delivery_visited'
        db.add_column('order_itemorder', 'delivery_visited', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ItemOrder.delivery_visited'
        db.delete_column('order_itemorder', 'delivery_visited')
    ...
    models = {
        ...
        'order.itemorder': {
            ...
            'delivery_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 8, 14, 26, 31, 176816)', 'null': 'True', 'blank': 'True'}),
        ...
        'order.order': {
            ...
            'new_total': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'order_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 8, 14, 26, 31, 174162)'}),
        ...
        'order.payment': {
            ...
            'payment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 8, 14, 26, 31, 175447)'}),
