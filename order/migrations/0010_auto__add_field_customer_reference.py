...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.reference'
        db.add_column('order_customer', 'reference', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customer.reference'
        db.delete_column('order_customer', 'reference')
    ...
    models = {
        ...
        'order.itemorder': {
            ...
            'delivery_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 15, 6, 43, 397371)', 'null': 'True', 'blank': 'True'}),
        ...
        'order.order': {
            ...
            'order_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 15, 6, 43, 394801)'}),
        ...
        'order.payment': {
            ...
            'payment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 15, 6, 43, 396078)'}),
