...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payment.others_desc'
        db.add_column('order_payment', 'others_desc', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Payment.others_value'
        db.add_column('order_payment', 'others_value', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Payment.others_desc'
        db.delete_column('order_payment', 'others_desc')

        # Deleting field 'Payment.others_value'
        db.delete_column('order_payment', 'others_value')
    ...
    models = {
        ...
        'order.itemorder': {
            ...
            'delivery_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 17, 3, 40, 422542)', 'null': 'True', 'blank': 'True'}),
        ...
        'order.order': {
            ...
            'order_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 17, 3, 40, 419956)'}),
        ...
        'order.payment': {
            ...
            'payment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 17, 3, 40, 421210)'}),
