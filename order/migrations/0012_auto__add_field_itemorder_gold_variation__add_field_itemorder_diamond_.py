...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ItemOrder.gold_variation'
        db.add_column('order_itemorder', 'gold_variation', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'ItemOrder.diamond_variation'
        db.add_column('order_itemorder', 'diamond_variation', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'ItemOrder.new_total'
        db.add_column('order_itemorder', 'new_total', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ItemOrder.gold_variation'
        db.delete_column('order_itemorder', 'gold_variation')

        # Deleting field 'ItemOrder.diamond_variation'
        db.delete_column('order_itemorder', 'diamond_variation')

        # Deleting field 'ItemOrder.new_total'
        db.delete_column('order_itemorder', 'new_total')
    ...
    models = {
        ...
        'order.itemorder': {
            ...
            'delivery_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 17, 35, 38, 779961)', 'null': 'True', 'blank': 'True'}),
        ...
        'order.order': {
            ...
            'order_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 17, 35, 38, 777179)'}),
        ...
        'order.payment': {
            ...
            'payment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 17, 35, 38, 778587)'}),
