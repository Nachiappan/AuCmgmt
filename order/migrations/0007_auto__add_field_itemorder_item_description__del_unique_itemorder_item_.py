...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ItemOrder', fields ['item', 'order']
        db.delete_unique('order_itemorder', ['item_id', 'order_id'])

        # Adding field 'ItemOrder.item_description'
        db.add_column('order_itemorder', 'item_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Payment.payment_date'
        db.add_column('order_payment', 'payment_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 8, 6, 5, 25, 37, 987698)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ItemOrder.item_description'
        db.delete_column('order_itemorder', 'item_description')

        # Adding unique constraint on 'ItemOrder', fields ['item', 'order']
        db.create_unique('order_itemorder', ['item_id', 'order_id'])

        # Deleting field 'Payment.payment_date'
        db.delete_column('order_payment', 'payment_date')
    ...
    models = {
        ...
        'order.itemorder': {
            ...
            'delivery_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 5, 25, 37, 989044)', 'null': 'True', 'blank': 'True'}),
        ...
        'order.order': {
            ...
            'order_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 5, 25, 37, 986310)'}),
            'payment_status': ('django.db.models.fields.CharField', [], {'default': "'D'", 'max_length': '1'}),
        ...
        'order.payment': {
            ...
            'payment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 6, 5, 25, 37, 987698)'}),
